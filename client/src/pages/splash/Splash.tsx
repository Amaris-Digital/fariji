          ...
          <div className='flex flex-col items-center pt-4 pb-8 gap-4'>
            <div className='flex flex-col items-center gap-2'>
              ...
              <p className='text-sm font-inter font-normal text-center text-[#373737] sm:pt-4 sm:pb-2 md:text-base'>
                Empower your loved ones with peace of mind. Let our funeral services ensure every
                detail is impeccably handled, leaving your family in perfect order.
              </p>
            </div>
            <button
        ...
        <div className='sm:w-96  p-6 '>
          ...
          <div className='flex flex-col items-center pt-4 pb-8 gap-4'>
            <div className='flex flex-col items-center gap-2'>
              ...
              <p className='text-sm font-inter font-normal text-center text-[#373737] sm:pt-4 sm:pb-2 md:text-base'>
                Share your authentic self through your own words, leaving behind a lasting tribute
                that honors your life.
              </p>
            </div>
            <button
              className='flex items-center justify-center w-full h-10 px-4 text-sm text-white bg-[#2A6476] rounded-lg md:text-base'
        ...
        <div className='sm:w-96  p-6 '>
          ...
          <div className='flex flex-col items-center pt-4 pb-8 gap-4'>
            <div className='flex flex-col items-center gap-2'>
              ...
              <p className='text-sm font-inter font-normal text-center text-[#373737] sm:pt-4 sm:pb-2 md:text-base'>
                Planning for the future can be a daunting task, but taking steps to prepare your
                loved ones in advance can alleviate the burden during challenging times.
              </p>
            </div>
            <button
              className='flex items-center justify-center w-full h-10 px-4 text-sm text-white bg-[#2A6476] rounded-lg md:text-base'
